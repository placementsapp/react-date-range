...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function getStateStyles() {
      ...
      return _extends({}, todayStyle, sundayStyle, inRangeStyle, hoverStyle, passiveStyle, activeStyle, selectedStyle);
    }
  }, {
    key: 'getClassNames',
    value: function getClassNames(classes) {
      ...
      return (0, _classnames3['default'])((_classnames = {}, _defineProperty(_classnames, classes.day, true), _defineProperty(_classnames, classes.dayActive, isSelected), _defineProperty(_classnames, classes.dayPassive, isPassive), _defineProperty(_classnames, classes.dayInRange, isInRange), _defineProperty(_classnames, classes.dayToday, isToday), _defineProperty(_classnames, classes.daySunday, isSunday), _classnames));
    }
  }, {
    key: 'render',

...
function checkRange(dayMoment, range) {
  return dayMoment.isBetween(range['startDate'], range['endDate'], null, '[]');
}
...
var Calendar = (function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderMonthAndYear(classes) {
      ...
      var showPrevMonthArrow = _props4.showPrevMonthArrow;
      var showNextMonthArrow = _props4.showNextMonthArrow;
      ...
      return _react2['default'].createElement(
        ...
        showPrevMonthArrow ? _react2['default'].createElement(
          'button',
          {
        ...
        showNextMonthArrow ? _react2['default'].createElement(
          'button',
          {
...
Calendar.propTypes = {
  showPrevMonthArrow: _react.PropTypes.bool,
  showNextMonthArrow: _react.PropTypes.bool,
